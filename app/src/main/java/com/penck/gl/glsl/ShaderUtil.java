...
public class ShaderUtil {
     ...
     */
    public static int loadGLShader(Context context, int shaderType, int glResId) {
        String shaderCode = readRawTextFile(context, glResId);
    ...
    public static void checkGLError(String label) {
        ...
        while ((error = GLES20.glGetError()) != GLES20.GL_NO_ERROR) {
            Log.e("ShaderUtil", label + ": glError " + error);
